...
- You still cannot equave shift edo/edx scales (change the root frequency if you want to go up an equave) or root frequencies (shift the note rather than the root frequency expression)
